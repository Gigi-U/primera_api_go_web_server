...
/* 
Objetivo
El objetivo de esta guía práctica es que podamos afianzar los conceptos sobre arquitectura web, JSON y Gin framework, vistos en este módulo.
Problema
Una empresa necesita un sistema para gestionar sus empleados. Para poder hacer esto, necesitan un servidor que ejecute una API que les permita manipular a los empleados.
